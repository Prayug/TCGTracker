...
function SidebarPanel({
  ...
  const selectClass =
    'h-9 w-full rounded-lg border border-border-default bg-surface-inset px-3 text-sm text-ink-primary transition-colors duration-200 focus:border-accent focus:outline-none';
  ...
  return (
    <div className="card h-full !p-4">
      ...
      <FilterGroup title={isOnePiece ? 'Color' : 'Type'} defaultOpen>
        <select
        ...
        >
          <option value="all">{isOnePiece ? 'All Colors' : 'All Types'}</option>
