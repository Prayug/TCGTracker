...
const DEMO_RAW: Row[] = [
  ...
  },
  {
    ...
    tcgplayerPrices: null,
    productId: 5,
    uniqueIdentifier: 'demo-giratina',
    subTypeName: 'Holofoil',
  ...
  },
  {
    ...
    tcgplayerPrices: null,
    productId: 7,
    uniqueIdentifier: 'demo-moonbreon',
    subTypeName: 'Holofoil',
    groupName: 'Evolving Skies',
    volume: 58,
    activity: 58,
