...
import { PackShop } from '../../packs/components/PackShop';
import { cn } from '@/lib/utils';

export const OpenPacksPage: React.FC = () => {
  const [searchParams, setSearchParams] = useSearchParams();
  const activeTab = searchParams.get('tab') === 'shop' ? 'shop' : 'sim';
        ...
        <>
          <div className="space-y-2">
            ...
            <p className="max-w-2xl text-sm text-ink-secondary">
              Open virtual One Piece TCG booster packs online. Pick a set, reveal 12 cards, chase
              manga rares and alternate arts — or rip a full booster box. Save pulls to your
              collection, all in your browser.
            </p>
          </div>
          ...
          <details className="group/odds rounded-2xl border border-border-subtle bg-surface-inset">
            ...
            <div className="border-t border-border-subtle px-5 py-4">
              <div className="overflow-x-auto" role="table" aria-label="Pull rates">
                ...
                {odds.map((row) => (
                  ...
                  >
                    ...
                    <span
                      role="cell"
                      className="text-right text-sm tabular-nums text-ink-secondary"
                    >
              ...
              <p className="mt-4 rounded-xl border border-border-subtle bg-surface-hover/60 p-3 text-xs leading-relaxed text-ink-muted">
                ...
                probabilities; booster boxes are case-mapped so box-level averages hold. This
                fan-made simulator is not affiliated with or endorsed by Bandai, Shueisha or Toei
                Animation.
              </p>
            </div>
          </details>
