  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? 'border-border-subtle bg-surface-base/75 shadow-sm backdrop-blur-2xl'
      ...
      <div className="flex h-14 items-center justify-between gap-4 px-4 sm:px-6">
        ...
        <div className="flex flex-1 items-center justify-end gap-2 sm:gap-3 md:flex-none">
          ...
          >
            ...
            <kbd className="rounded border border-border-subtle bg-surface-raised/80 px-1.5 py-0.5 font-mono text-[10px] text-ink-muted">
              {isMac ? '⌘K' : 'Ctrl K'}
            </kbd>
          </button>
