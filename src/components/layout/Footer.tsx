...
export const Footer: React.FC = () => {
  return (
    <footer className="mt-auto border-t border-border-subtle bg-surface-inset/80">
      <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-2 px-4 py-4 text-xs text-ink-secondary sm:flex-row sm:items-center sm:px-6">
        <span className="tracking-wide text-ink-secondary">© 2026 TCG Tracker · Foil Gallery</span>
