...
const envSchema = zod_1.z.object({
    ...
    EBAY_CLIENT_ID: zod_1.z.string().optional(),
    EBAY_CLIENT_SECRET: zod_1.z.string().optional(),
    EBAY_ENV: zod_1.z.enum(['production', 'sandbox']).default('production'),
    EBAY_VERIFICATION_TOKEN: zod_1.z.string().optional(),
    EBAY_NOTIFICATION_ENDPOINT: zod_1.z.string().optional(),
...
exports.env = {
    ...
    ebay: {
        clientId: parsedEnv.data.EBAY_CLIENT_ID,
        clientSecret: parsedEnv.data.EBAY_CLIENT_SECRET,
        sandbox: parsedEnv.data.EBAY_ENV === 'sandbox',
        verificationToken: parsedEnv.data.EBAY_VERIFICATION_TOKEN,
        notificationEndpoint: parsedEnv.data.EBAY_NOTIFICATION_ENDPOINT,
    },
    email: {
