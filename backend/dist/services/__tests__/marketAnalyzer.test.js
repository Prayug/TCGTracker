...
describe('getPriceAtDate', () => {
    it('returns the price on or before the target date', () => {
        ...
        expect((0, marketAnalyzer_1.getPriceAtDate)(points, new Date('2026-07-18T00:00:00Z'))).toBe(12);
    });
    it('handles T-timestamps in the input series', () => {
        ...
        expect((0, marketAnalyzer_1.getPriceAtDate)(points, new Date('2026-07-12T00:00:00Z'))).toBe(10);
    });
    it('returns null when no quote predates the target', () => {
        expect((0, marketAnalyzer_1.getPriceAtDate)([point('2026-07-10', 10)], new Date('2026-07-01T00:00:00Z'))).toBeNull();
    });
});
describe('computeMovingAverages (calendar windows)', () => {
    ...
    it('ma7 averages only quotes within the trailing 7 calendar days', () => {
        const { ma7 } = (0, marketAnalyzer_1.computeMovingAverages)(pts);
    ...
    it('ma30 spans the full trailing month including sparse quotes', () => {
        const { ma30 } = (0, marketAnalyzer_1.computeMovingAverages)(pts);
        // 2026-06-18 .. 07-17 -> [100, 100, 90, 110, 100, 110]
        expect(ma30).toBeCloseTo(610 / 6);
    });
    it('ma90 covers the whole series', () => {
        const { ma90 } = (0, marketAnalyzer_1.computeMovingAverages)(pts);
        expect(ma90).toBeCloseTo((100 + 100 + 90 + 110 + 100 + 110) / 6);
    });
    it('returns nulls for empty series', () => {
        expect((0, marketAnalyzer_1.computeMovingAverages)([])).toEqual({ ma7: null, ma30: null, ma90: null });
    });
});
describe('computeVolatility (gap-normalized)', () => {
    it('volatility is dampened when the series has multi-day gaps', () => {
        ...
        const denseVol = (0, marketAnalyzer_1.computeVolatility)(weekly).dailyVolatility;
        const sparseVol = (0, marketAnalyzer_1.computeVolatility)(sparse).dailyVolatility;
    ...
    it('raises uncertainty defaults for sparse data (< 7 points)', () => {
        const vol = (0, marketAnalyzer_1.computeVolatility)([point('2026-07-01', 100), point('2026-07-05', 105)]);
    ...
    it('returns default uncertainty for empty series', () => {
        const vol = (0, marketAnalyzer_1.computeVolatility)([]);
