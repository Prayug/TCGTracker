 ...
 */
router.get('/sets/:setId/cards', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { setId } = req.params;
        if (!(setId === null || setId === void 0 ? void 0 : setId.trim())) {
            return res.status(400).json({ error: 'Set ID is required' });
        }
        const setMeta = yield (0, setTrackerService_1.resolveSetMeta)(setId);
        if (!setMeta) {
            return res.status(404).json({ error: 'Set not found', setId });
        }
        const rows = yield (0, setTrackerService_1.fetchSetCatalogRows)(setId);
        ...
        const data = cards.map((card) => (Object.assign(Object.assign({}, card), { owned: ownedIds.has(card.id) })));
        res.json({
            set: setMeta,
            data,
            count: data.length,
 ...
 */
router.get('/sets/:setId/summary', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { setId } = req.params;
        if (!(setId === null || setId === void 0 ? void 0 : setId.trim())) {
            return res.status(400).json({ error: 'Set ID is required' });
 ...
 */
router.get('/sets/:setId/value-history', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { setId } = req.params;
        ...
        const history = yield (0, setTrackerService_1.fetchSetValueHistory)(setId, range);
        res.json({
            setId: setMeta.id,
